...
public class WxaAPI extends BaseAPI {
	...
	private static final String jscode2session="/sns/jscode2session";
	public static SessionDataResult getSessionDataResult(String jscode,String appid,String secret) {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
				.setHeader(jsonHeader)
				.setUri(BASE_URI +jscode2session)
				.addParameter("js_code", jscode)
				.addParameter("secret",secret)
				.addParameter("appid",appid)
				.build();
		return LocalHttpClient.executeJsonResult(httpUriRequest,SessionDataResult.class);
	}
	/**
	 * 修改服务器地址<br>
     * 设置小程序服务器域名
