...
public class PayMchAPI extends BaseAPI{
	...
	public static void main(String[] args) {
		String unifiedorderXML="<xml>\r\n" + 
				"    <appid>wx57af29bdae81b789</appid>\n" + 
				"    <mch_id>1600582956</mch_id>\n" + 
				"    <nonce_str>1de4b12e73c34d5ea50bce0488c6ad20</nonce_str>\n" + 
				"    <sign>C8BDEDB08756ADBC7F19C6704D7C3FD9</sign>\n" + 
				"    <body>VIP会员</body>\n" + 
				"    <attach>20200724183125</attach>\n" + 
				"    <out_trade_no>20200724183125</out_trade_no>\n" + 
				"    <total_fee>0.01</total_fee>\n" + 
				"    <spbill_create_ip>124.64.16.111</spbill_create_ip>\n" + 
				"    <notify_url>https://lycymr.cn/renren-api/notify</notify_url>\n" + 
				"    <trade_type>JSAPI</trade_type>\n" + 
				"    <openid>ot-Yw5ZUaOfav6Sa8zUFeB3th2oA</openid>\n" + 
				"</xml>";
		HttpUriRequest httpUriRequest = RequestBuilder.post()
				.setHeader(xmlHeader)
				.setUri(baseURI()+ "/pay/unifiedorder")
				.setEntity(new StringEntity(unifiedorderXML,Charset.forName("utf-8")))
				.build();
		LocalHttpClient.executeXmlResult(httpUriRequest,UnifiedorderResult.class,"MD5","33c8291441816e3103d2c5d2153ca02f");
	}
